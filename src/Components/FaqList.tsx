...
const faqData = [
  ...
  {
    question: "Hur spelar man Matcha Ord och Memory?",
    answer: `Det är väldigt enkelt att spela båda spelen. \n Börja med att välja vilket av spelen du vill spela, välj en svårighetsgrad eller storlek på spelplanen och klicka sedan på korten, ett i taget, för att vända dem. Om två kort som vänts inte matchar vänds de tillbaka igen, annars ligger de kvar med bilden/ordet uppvänt. Därefter klickar man på ytterligare två kort för att försöka matcha nästa par. \n När alla kort är ligger kvar vända med bilden/ordet uppåt kan man välja att antingen spela samma spel igen eller välja en ny svårighetsgrad.`
  },
  {
